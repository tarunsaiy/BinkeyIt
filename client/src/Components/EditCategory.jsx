    ...
    <section className='fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 flex items-center justify-center'>
                <div className="bg-white max-w-4xl w-full p-4 rounded">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='grid gap-4'>
                            ...
                            <div className="flex gap-5 flex-col lg:flex-row items-center">
                                ...
                                <label htmlFor='image' className='cursor-pointer'>
                                    <div className={`${!data.name ? "bg-gray-400" : "bg-amber-300"} px-4 py-2 rounded lg:h-auto w-auto cursor-pointer`}>{loading ? "Loading..." : "Upload Image"}</div>
                        ...
                        <button className={`${data.name && data.image ? "bg-amber-400" : "bg-gray-400"} px-4 py-2 w-full mt-6 rounded hover:cursor-pointer`} disabled={!data.name || !data.image}>Update Category</button>
                    </form>
                </div >
